...
const categories = {
  shop:{ label:'General Shop', products:[
    ...
    {id:29,name:'Tomato Paste 150g',price:95,icon:'🍅'},{id:30,name:'Royco Beef 75g',price:85,icon:'🥄'},
    {id:31,name:'Margarine 500g',price:260,icon:'🧈'},{id:32,name:'Nescafe 200g',price:750,icon:'☕'},
    {id:33,name:'Honey 250ml',price:350,icon:'🍯'},{id:34,name:'Jam Strawberry 400g',price:280,icon:'🍓'},
    {id:35,name:'Peanut Butter 400g',price:320,icon:'🥜'},{id:36,name:'Tissue Roll x4',price:180,icon:'🧻'},
    {id:37,name:'Garbage Bags x10',price:150,icon:'🗑️'},{id:38,name:'Washing Up Liquid 500ml',price:130,icon:'🧴'},
  ]},
  pharmacy:{ label:'Pharmacy', products:[
    ...
    {id:119,name:'Cotton Wool 100g',price:120,icon:'🩹',tag:'OTC'},{id:120,name:'Multivitamin x30',price:350,icon:'💊',tag:'OTC'},
    {id:121,name:'Iron + Folate x30',price:220,icon:'💊',tag:'OTC'},{id:122,name:'Metformin 500mg x30',price:280,icon:'💉',tag:'POM'},
    {id:123,name:'Atorvastatin 20mg x30',price:650,icon:'💉',tag:'POM'},{id:124,name:'Salbutamol Inhaler',price:680,icon:'💉',tag:'POM'},
    {id:125,name:'Cough Syrup 100ml',price:220,icon:'💊',tag:'OTC'},{id:126,name:'Pregnancy Test Kit',price:180,icon:'💊',tag:'OTC'},
    {id:127,name:'Face Mask x10',price:150,icon:'💊',tag:'OTC'},{id:128,name:'Gloves Latex x10',price:200,icon:'💊',tag:'OTC'},
    {id:129,name:'Sunscreen SPF50 100ml',price:750,icon:'💊',tag:'OTC'},{id:130,name:'Eye Drops Lubricant',price:350,icon:'💊',tag:'OTC'},
  ]},
  airbnb:{ label:'Hospitality', products:[
    ...
    {id:211,name:'Late Checkout Fee',price:1000,icon:'⏰'},{id:212,name:'Laundry Service',price:500,icon:'👕'},
    {id:213,name:'City Tour 4hrs',price:3500,icon:'🗺️'},{id:214,name:'Pool Access',price:500,icon:'🏊'},
    {id:215,name:'Spa 1hr',price:2500,icon:'💆'},{id:216,name:'Conference Room Half-Day',price:5000,icon:'📊'},
  ]},
  electronics:{ label:'Electronics', products:[
    ...
    {id:305,name:'Bluetooth Speaker',price:2800,icon:'🔊'},{id:306,name:'Portable Charger 10000mAh',price:1600,icon:'🔋'},
    {id:307,name:'Smartwatch',price:6800,icon:'⌚'},{id:308,name:'USB-C Cable 1m',price:280,icon:'🔌'},
    {id:309,name:'Wall Charger 65W',price:1200,icon:'🔌'},{id:310,name:'Memory Card 64GB',price:900,icon:'💾'},
    {id:311,name:'Laptop Stand',price:1800,icon:'💻'},{id:312,name:'Wireless Mouse',price:1200,icon:'🖱️'},
    {id:313,name:'LED Strip 5m',price:1500,icon:'💡'},{id:314,name:'Digital Camera Basic',price:12000,icon:'📷'},
  ]},
  salon:{ label:'Salon & Beauty', products:[
    {id:401,name:'Haircut (Men)',price:850,icon:'✂️'},{id:402,name:'Haircut (Women)',price:1200,icon:'✂️'},
    {id:403,name:'Beard Trim',price:450,icon:'✂️'},{id:404,name:'Manicure',price:1200,icon:'💅'},
    {id:405,name:'Pedicure',price:1500,icon:'💅'},{id:406,name:'Gel Nails',price:2200,icon:'💅'},
    {id:407,name:'Facial Basic',price:2200,icon:'✂️'},{id:408,name:'Blow Dry',price:700,icon:'✂️'},
    {id:409,name:'Hair Colour Full',price:4500,icon:'✂️'},{id:410,name:'Braids Full Head',price:4500,icon:'✂️'},
    {id:411,name:'Eyebrow Threading',price:300,icon:'✂️'},{id:412,name:'Eyelash Extensions',price:3500,icon:'✂️'},
  ]},
  cafe:{ label:'Cafe & Restaurant', products:[
    {id:501,name:'Espresso Single',price:180,icon:'☕'},{id:502,name:'Cappuccino',price:280,icon:'☕'},
    {id:503,name:'Latte',price:320,icon:'☕'},{id:504,name:'Americano',price:220,icon:'☕'},
    {id:505,name:'Chai Tea',price:150,icon:'☕'},{id:506,name:'Hot Chocolate',price:350,icon:'☕'},
    {id:507,name:'Smoothie Berry',price:390,icon:'☕'},{id:508,name:'Fresh Juice Orange',price:250,icon:'☕'},
    {id:509,name:'Sandwich Club',price:420,icon:'🍽️'},{id:510,name:'Cake Slice',price:320,icon:'🍽️'},
    {id:511,name:'Breakfast Full',price:850,icon:'🍽️'},{id:512,name:'Pasta Carbonara',price:680,icon:'🍽️'},
    {id:513,name:'Pizza Margherita',price:850,icon:'🍽️'},{id:514,name:'Burger Classic',price:650,icon:'🍽️'},
    {id:515,name:'Ugali & Stew',price:350,icon:'🍽️'},{id:516,name:'Nyama Choma 200g',price:850,icon:'🍽️'},
  ]},
  laundry:{ label:'Laundry', products:[
    ...
    {id:605,name:'Bedsheet Wash & Iron',price:250,icon:'👔'},{id:606,name:'Express Laundry 2kg',price:450,icon:'👔'},
  ]},
  hardware:{ label:'Hardware', products:[
    {id:701,name:'Hammer',price:650,icon:'🔧'},{id:702,name:'Screwdriver Set',price:850,icon:'🔧'},
    {id:703,name:'Paint Roller',price:350,icon:'🔧'},{id:704,name:'Wall Paint 4L White',price:1800,icon:'🔧'},
    {id:705,name:'Door Lock',price:1200,icon:'🔧'},{id:706,name:'Safety Gloves',price:320,icon:'🔧'},
  ]},
}
    ...
    <div className="login-portal">
      ...
      <div className="login-box" role="main" aria-label="BerylBytes Login">
        <div className="login-logo">
          ...
          <div className="brand-logo-fb" style={{display:'none',margin:'0 auto 10px',width:52,height:52,borderRadius:12,fontSize:22}}>B</div>
          <div className="login-brand">Beryl<em>Bytes</em></div>
          <div className="login-brand-sub">Enterprise Point of Sale</div>
        </div>

        {step==='select' && (<>
          <h2 className="login-title">Select Account</h2>
...
}nChange={e=>setNewItem({...newItem,icon:e.target.value})} placeholder="Optional"/></div>
                    <div className="sf full"><label>Category</label><select value={newItem.category} onChange={e=>setNewItem({...newItem,category:e.target.value})}>{Object.entries(categories).map(([k,v])=><option key={k} value={k}>{v.label}</option>)}</select></div>
                  </div>
                  <button className="btn-p" style={{marginTop:16,width:'100%'}} onClick={()=>{if(!newItem.name||!newItem.price){flash('Name and price are required.','error');return};setCustomItems(p=>[...p,{id:Date.now(),...newItem,price:parseInt(newItem.price)}]);flash('Item added to catalogue.');setNewItem({name:'',price:'',category:'shop',icon:''});setView('pos')}}>Add to Catalogue</button>
                  <p className="help-text">The item will appear in the selected category immediately and can be sold from the POS.</p>
